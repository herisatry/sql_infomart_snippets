...
COUNT(IRF.INTERACTION_ID) AS [TOTAL INBOUND ],
...
SUM(IRF.TALK_DURATION + IRF.HOLD_DURATION + IRF.AFTER_CALL_WORK_DURATION ) / COUNT(IRF.INTERACTION_ID) AS AHT
...
WHERE (IRF.HANDLE_COUNT <> 0 AND IT.INTERACTION_TYPE_CODE = 'INBOUND') AND DT.LABEL_YYYY_MM_DD = '2019-12-16' AND R.RESOURCE_NAME LIKE 'a.l%'
...
GROUP BY R.RESOURCE_NAME, DT.LABEL_YYYY_MM_DD, MT.MEDIA_NAME
