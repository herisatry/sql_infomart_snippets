...
-- ,CASE WHEN RS.STATE_NAME ='Ready' THEN COUNT(SRSTF.SM_RES_STATE_FACT_KEY) ELSE '' END AS [# of Ready]
-- ,CASE WHEN RS.STATE_NAME ='NotReady' THEN COUNT(SRSTF.SM_RES_STATE_FACT_KEY) ELSE '' END AS [# of Not Ready]
-- ,CASE WHEN RS.STATE_NAME ='Busy' THEN COUNT(SRSTF.SM_RES_STATE_FACT_KEY) ELSE '' END AS [# Busy]
-- ,CASE WHEN RS.STATE_NAME ='AfterCallWork' THEN COUNT(SRSTF.SM_RES_STATE_FACT_KEY) ELSE '' END AS [# of AfterCallWork]
--,COUNT( distinct SRSTF.SM_RES_SESSION_FACT_KEY) AS [# Of Sessions]
