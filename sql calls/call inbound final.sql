...
WHERE IRF.TALK_COUNT>0 
 	AND ( IT.INTERACTION_TYPE='Inbound' OR IT.INTERACTION_TYPE='Outbound')
...
GROUP BY DATE.LABEL_YYYY_MM_DD ,R.RESOURCE_NAME, R.AGENT_FIRST_NAME, R.AGENT_LAST_NAME, DATE.LABEL_HH24
