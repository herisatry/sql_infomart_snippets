SELECT DATE.LABEL_YYYY_MM_DD_HH24 AS Date,
...
WHERE DATE.LABEL_YYYY_MM_DD_HH24>='2019-11-01'
...
GROUP BY DATE.LABEL_YYYY_MM_DD_HH24, VQ.RESOURCE_NAME, R.AGENT_FIRST_NAME, R.AGENT_LAST_NAME

ORDER BY DATE.LABEL_YYYY_MM_DD_HH24, VQ.RESOURCE_NAME