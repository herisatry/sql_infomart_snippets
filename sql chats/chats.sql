SELECT DATE.LABEL_YYYY_MM_DD_HH24 AS Date,
		...
		-- COUNT	(DISTINCT CASE WHEN CSF.MSG_FROM_CUSTOMERS_COUNT>0 AND TD.TECHNICAL_RESULT IN ('Abandoned','CustomerAbandoned') THEN CSF.MEDIA_SERVER_IXN_GUID END) AS 'Missed Chat', 
		--все неотвеченные чаты
...
WHERE -- DATE.LABEL_YYYY_MM_DD='2019-10-16'
-- 	AND 
...
GROUP BY DATE.LABEL_YYYY_MM_DD_HH24, R.RESOURCE_NAME

ORDER BY DATE.LABEL_YYYY_MM_DD_HH24, R.RESOURCE_NAME