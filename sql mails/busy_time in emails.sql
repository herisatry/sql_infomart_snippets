...
left join INFOMART.dbo.DATE_TIME DT on IRF.END_DATE_TIME_KEY=DT.DATE_TIME_KEY
left join INFOMART.dbo.DATE_TIME DT2 ON IRF.START_DATE_TIME_KEY = DT2.DATE_TIME_KEY
...
left join SM_RES_STATE_FACT SRSTF ON SRSTF.RESOURCE_KEY = R2.RESOURCE_KEY
left join RESOURCE_STATE RS ON SRSTF.RESOURCE_STATE_KEY = RS.RESOURCE_STATE_KEY
